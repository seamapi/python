...
def test_connect_webviews(seam: Seam):
    ...
    webview = seam.connect_webviews.get(connect_webview_id=created_webview.connect_webview_id)
    ...
    webview = seam.connect_webviews.get(connect_webview_id=new_webview.connect_webview_id)
