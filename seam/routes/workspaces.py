...
class AbstractWorkspaces(abc.ABC):
    ...
    @abc.abstractmethod
    def create(self, *, name: str, company_name: Optional[str] = None, connect_partner_name: Optional[Union[str, Null]] = None, connect_webview_customization: Optional[Dict[str, Any]] = None, is_sandbox: Optional[bool] = None, organization_id: Optional[str] = None, webview_logo_shape: Optional[str] = None, webview_primary_button_color: Optional[str] = None, webview_primary_button_text_color: Optional[str] = None, webview_success_message: Optional[str] = None) -> Workspace:
    ...
    @abc.abstractmethod
    def reset_sandbox(self, *, wait_for_action_attempt: Optional[Union[bool, Dict[str, float]]] = None) -> ActionAttempt:
    ...
    @abc.abstractmethod
    def update(self, *, connect_partner_name: Optional[str] = None, connect_webview_customization: Optional[Dict[str, Any]] = None, is_publishable_key_auth_enabled: Optional[bool] = None, is_suspended: Optional[bool] = None, name: Optional[str] = None, organization_id: Optional[str] = None) -> None:
...
class Workspaces(AbstractWorkspaces):
    ...
    @route_metadata(path="/workspaces/create", has_required_parameters=True, has_pagination=False)
    def create(self, *, name: str, company_name: Optional[str] = None, connect_partner_name: Optional[Union[str, Null]] = None, connect_webview_customization: Optional[Dict[str, Any]] = None, is_sandbox: Optional[bool] = None, organization_id: Optional[str] = None, webview_logo_shape: Optional[str] = None, webview_primary_button_color: Optional[str] = None, webview_primary_button_text_color: Optional[str] = None, webview_success_message: Optional[str] = None) -> Workspace:
        """Creates a new `workspace <https://docs.seam.co/core-concepts/workspaces>`_.
        ...
        if connect_webview_customization is not None:
            json_payload["connect_webview_customization"] = connect_webview_customization
        ...
        if webview_primary_button_text_color is not None:
            json_payload["webview_primary_button_text_color"] = webview_primary_button_text_color
        if webview_success_message is not None:
            json_payload["webview_success_message"] = webview_success_message

        if not json_payload:
            raise ValueError("At least one parameter is required for /workspaces/create")

        res = self.client.post("/workspaces/create", json=json_payload)

        return Workspace.from_dict(res["workspace"])

    @route_metadata(path="/workspaces/get", has_required_parameters=False, has_pagination=False)
    def get(self) -> Workspace:
        """Returns the `workspace <https://docs.seam.co/core-concepts/workspaces>`_ associated with the authentication value.
    ...
    @route_metadata(path="/workspaces/list", has_required_parameters=False, has_pagination=False)
    def list(self) -> List[Workspace]:
        """Returns a list of `workspaces <https://docs.seam.co/core-concepts/workspaces>`_ associated with the authentication value.
    ...
    @route_metadata(path="/workspaces/reset_sandbox", has_required_parameters=False, has_pagination=False)
    def reset_sandbox(self, *, wait_for_action_attempt: Optional[Union[bool, Dict[str, float]]] = None) -> ActionAttempt:
        """Resets the `sandbox workspace <https://docs.seam.co/core-concepts/workspaces#sandbox-workspaces>`_ associated with the authentication value. Note that this endpoint is only available for sandbox workspaces.
    ...
    @route_metadata(path="/workspaces/update", has_required_parameters=False, has_pagination=False)
    def update(self, *, connect_partner_name: Optional[str] = None, connect_webview_customization: Optional[Dict[str, Any]] = None, is_publishable_key_auth_enabled: Optional[bool] = None, is_suspended: Optional[bool] = None, name: Optional[str] = None, organization_id: Optional[str] = None) -> None:
        """Updates the `workspace <https://docs.seam.co/core-concepts/workspaces>`_ associated with the authentication value.
        ...
        if is_publishable_key_auth_enabled is not None:
            json_payload["is_publishable_key_auth_enabled"] = is_publishable_key_auth_enabled
