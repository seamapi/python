...
class AbstractThermostatsSimulate(abc.ABC):
    ...
    def hvac_mode_adjusted(
        ...
        *,
        device_id: str,
        hvac_mode: Literal["off", "cool", "heat", "heat_cool"],
...
class AbstractAsyncThermostatsSimulate(abc.ABC):
...
class AsyncThermostatsSimulate(AbstractAsyncThermostatsSimulate):
