...
from ..resources import ThermostatDailyProgram, ActionAttempt, action_attempt_from_dict
...
class AbstractAsyncThermostatsDailyPrograms(abc.ABC):
...
class AsyncThermostatsDailyPrograms(AbstractAsyncThermostatsDailyPrograms):
