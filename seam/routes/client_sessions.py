...
class AbstractAsyncClientSessions(abc.ABC):
...
class AsyncClientSessions(AbstractAsyncClientSessions):
    ...
    async def grant_access(
        ...
        *,
        ...
        await self.client.patch("/client_sessions/grant_access", json=json_payload)
