...
class AbstractAsyncAcsUsers(abc.ABC):
...
class AsyncAcsUsers(AbstractAsyncAcsUsers):
    ...
    async def suspend(
        ...
        *,
        ...
        await self.client.post("/acs/users/suspend", json=json_payload)
    ...
    async def unsuspend(
        ...
        *,
        ...
        await self.client.post("/acs/users/unsuspend", json=json_payload)
