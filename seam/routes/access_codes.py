...
from .access_codes_simulate import (
    AbstractAccessCodesSimulate,
    AccessCodesSimulate,
    AbstractAsyncAccessCodesSimulate,
    AsyncAccessCodesSimulate,
)
from .access_codes_unmanaged import (
    AbstractAccessCodesUnmanaged,
    AccessCodesUnmanaged,
...
class AbstractAsyncAccessCodes(abc.ABC):

    @property
    @abc.abstractmethod
    def simulate(self) -> AbstractAsyncAccessCodesSimulate:
        raise NotImplementedError()

    @property
    @abc.abstractmethod
    def unmanaged(self) -> AbstractAsyncAccessCodesUnmanaged:
        raise NotImplementedError()
...
class AsyncAccessCodes(AbstractAsyncAccessCodes):
    def __init__(self, client: AsyncSeamHttpClient, defaults: Dict[str, Any]):
        self.client = client
        self.defaults = defaults
        self._simulate = AsyncAccessCodesSimulate(client=client, defaults=defaults)
        self._unmanaged = AsyncAccessCodesUnmanaged(client=client, defaults=defaults)

    @property
    def simulate(self) -> AsyncAccessCodesSimulate:
        return self._simulate

    @property
    def unmanaged(self) -> AsyncAccessCodesUnmanaged:
        return self._unmanaged
