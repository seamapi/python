...
class AbstractAccessCodes(abc.ABC):
    ...
    @abc.abstractmethod
    def create_multiple(self, *, device_ids: List[str], allow_external_modification: Optional[bool] = None, attempt_for_offline_device: Optional[bool] = None, behavior_when_code_cannot_be_shared: Optional[str] = None, code: Optional[str] = None, ends_at: Optional[str] = None, is_external_modification_allowed: Optional[bool] = None, name: Optional[str] = None, prefer_native_scheduling: Optional[bool] = None, preferred_code_length: Optional[float] = None, starts_at: Optional[str] = None, use_backup_access_code_pool: Optional[bool] = None) -> List[AccessCode]:
    ...
    @abc.abstractmethod
    def get(self, *, access_code_id: Optional[str] = None, code: Optional[str] = None, device_id: Optional[str] = None) -> AccessCode:
    ...
    @abc.abstractmethod
    def list(self, *, access_code_ids: Optional[List[str]] = None, access_grant_id: Optional[str] = None, access_grant_key: Optional[str] = None, access_method_id: Optional[str] = None, customer_key: Optional[str] = None, device_id: Optional[str] = None, limit: Optional[float] = None, page_cursor: Optional[Union[str, Null]] = None, search: Optional[str] = None, user_identifier_key: Optional[str] = None) -> List[AccessCode]:
    ...
    @abc.abstractmethod
    def report_device_constraints(self, *, device_id: str, max_code_length: Optional[int] = None, min_code_length: Optional[int] = None, supported_code_lengths: Optional[List[float]] = None) -> None:
    ...
    @abc.abstractmethod
    def update_multiple(self, *, common_code_key: str, ends_at: Optional[str] = None, name: Optional[str] = None, starts_at: Optional[str] = None) -> None:
...
class AccessCodes(AbstractAccessCodes):
    ...
    @route_metadata(path="/access_codes/create", has_required_parameters=True, has_pagination=False)
    def create(self, *, device_id: str, allow_external_modification: Optional[bool] = None, attempt_for_offline_device: Optional[bool] = None, code: Optional[str] = None, common_code_key: Optional[str] = None, ends_at: Optional[str] = None, is_external_modification_allowed: Optional[bool] = None, is_offline_access_code: Optional[bool] = None, is_one_time_use: Optional[bool] = None, max_time_rounding: Optional[str] = None, name: Optional[str] = None, prefer_native_scheduling: Optional[bool] = None, preferred_code_length: Optional[float] = None, starts_at: Optional[str] = None, use_backup_access_code_pool: Optional[bool] = None, use_offline_access_code: Optional[bool] = None) -> AccessCode:
        """Creates a new `access code <https://docs.seam.co/low-level-apis/access-codes>`_. For granting access, we recommend `Access Grants <https://docs.seam.co/use-cases/granting-access>`_ instead: they work across both standalone smart locks and access control systems and manage the underlying codes for you. Use this low-level endpoint only when you need direct control over a code on a single device, such as setting a custom PIN value.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/create")

        res = self.client.post("/access_codes/create", json=json_payload)

        return AccessCode.from_dict(res["access_code"])

    @route_metadata(path="/access_codes/create_multiple", has_required_parameters=True, has_pagination=False)
    def create_multiple(self, *, device_ids: List[str], allow_external_modification: Optional[bool] = None, attempt_for_offline_device: Optional[bool] = None, behavior_when_code_cannot_be_shared: Optional[str] = None, code: Optional[str] = None, ends_at: Optional[str] = None, is_external_modification_allowed: Optional[bool] = None, name: Optional[str] = None, prefer_native_scheduling: Optional[bool] = None, preferred_code_length: Optional[float] = None, starts_at: Optional[str] = None, use_backup_access_code_pool: Optional[bool] = None) -> List[AccessCode]:
        """Creates new `access codes <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_ that share a common code across multiple devices.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/create_multiple")
    ...
    @route_metadata(path="/access_codes/delete", has_required_parameters=True, has_pagination=False)
    def delete(self, *, access_code_id: str, device_id: Optional[str] = None) -> None:
        """Deletes an `access code <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_.
        ...
        if not params:
            raise ValueError("At least one parameter is required for /access_codes/delete")

        self.client.delete("/access_codes/delete", params=params)

        return None

    @route_metadata(path="/access_codes/generate_code", has_required_parameters=True, has_pagination=False)
    def generate_code(self, *, device_id: str) -> AccessCode:
        """Generates a code for an `access code <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_, given a device ID.
        ...
        if not params:
            raise ValueError("At least one parameter is required for /access_codes/generate_code")

        res = self.client.get("/access_codes/generate_code", params=params)

        return AccessCode.from_dict(res["generated_code"])

    @route_metadata(path="/access_codes/get", has_required_parameters=True, has_pagination=False)
    def get(self, *, access_code_id: Optional[str] = None, code: Optional[str] = None, device_id: Optional[str] = None) -> AccessCode:
        """Returns a specified `access code <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_.
    ...
    @route_metadata(path="/access_codes/list", has_required_parameters=True, has_pagination=True)
    def list(self, *, access_code_ids: Optional[List[str]] = None, access_grant_id: Optional[str] = None, access_grant_key: Optional[str] = None, access_method_id: Optional[str] = None, customer_key: Optional[str] = None, device_id: Optional[str] = None, limit: Optional[float] = None, page_cursor: Optional[Union[str, Null]] = None, search: Optional[str] = None, user_identifier_key: Optional[str] = None) -> List[AccessCode]:
        """Returns a list of all `access codes <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/list")

        res = self.client.post("/access_codes/list", json=json_payload)

        return [AccessCode.from_dict(item) for item in res["access_codes"]]

    @route_metadata(path="/access_codes/pull_backup_access_code", has_required_parameters=True, has_pagination=False)
    def pull_backup_access_code(self, *, access_code_id: str) -> AccessCode:
        """Retrieves a backup access code for an `access code <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_. See also `Managing Backup Access Codes <https://docs.seam.co/low-level-apis/smart-locks/access-codes/backup-access-codes>`_.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/pull_backup_access_code")

        res = self.client.post("/access_codes/pull_backup_access_code", json=json_payload)

        return AccessCode.from_dict(res["access_code"])

    @route_metadata(path="/access_codes/report_device_constraints", has_required_parameters=True, has_pagination=False)
    def report_device_constraints(self, *, device_id: str, max_code_length: Optional[int] = None, min_code_length: Optional[int] = None, supported_code_lengths: Optional[List[float]] = None) -> None:
        """Enables you to report access code-related constraints for a device. Currently, supports reporting supported code length constraints for SmartThings devices.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/report_device_constraints")

        self.client.post("/access_codes/report_device_constraints", json=json_payload)

        return None

    @route_metadata(path="/access_codes/update", has_required_parameters=True, has_pagination=False)
    def update(self, *, access_code_id: str, allow_external_modification: Optional[bool] = None, attempt_for_offline_device: Optional[bool] = None, code: Optional[str] = None, device_id: Optional[str] = None, ends_at: Optional[str] = None, is_external_modification_allowed: Optional[bool] = None, is_managed: Optional[bool] = None, name: Optional[str] = None, starts_at: Optional[str] = None, type: Optional[str] = None) -> None:
        """Updates a specified active or upcoming `access code <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/update")

        self.client.put("/access_codes/update", json=json_payload)

        return None

    @route_metadata(path="/access_codes/update_multiple", has_required_parameters=True, has_pagination=False)
    def update_multiple(self, *, common_code_key: str, ends_at: Optional[str] = None, name: Optional[str] = None, starts_at: Optional[str] = None) -> None:
        """Updates `access codes <https://docs.seam.co/low-level-apis/smart-locks/access-codes>`_ that share a common code across multiple devices.
        ...
        if not json_payload:
            raise ValueError("At least one parameter is required for /access_codes/update_multiple")
