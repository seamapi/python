...
class AbstractConnectWebviews(abc.ABC):
    ...
    @abc.abstractmethod
    def create(self, *, accepted_capabilities: Optional[List[str]] = None, accepted_providers: Optional[List[str]] = None, automatically_manage_new_devices: Optional[bool] = None, custom_metadata: Optional[Dict[str, Any]] = None, custom_redirect_failure_url: Optional[str] = None, custom_redirect_url: Optional[str] = None, customer_key: Optional[str] = None, excluded_providers: Optional[List[str]] = None, provider_category: Optional[str] = None, wait_for_device_creation: Optional[bool] = None) -> ConnectWebview:
    ...
    @abc.abstractmethod
    def list(self, *, custom_metadata_has: Optional[Dict[str, Any]] = None, customer_key: Optional[str] = None, limit: Optional[float] = None, page_cursor: Optional[Union[str, Null]] = None, search: Optional[str] = None, user_identifier_key: Optional[str] = None) -> List[ConnectWebview]:
...
class ConnectWebviews(AbstractConnectWebviews):
    ...
    @route_metadata(path="/connect_webviews/create", has_required_parameters=False, has_pagination=False)
    def create(self, *, accepted_capabilities: Optional[List[str]] = None, accepted_providers: Optional[List[str]] = None, automatically_manage_new_devices: Optional[bool] = None, custom_metadata: Optional[Dict[str, Any]] = None, custom_redirect_failure_url: Optional[str] = None, custom_redirect_url: Optional[str] = None, customer_key: Optional[str] = None, excluded_providers: Optional[List[str]] = None, provider_category: Optional[str] = None, wait_for_device_creation: Optional[bool] = None) -> ConnectWebview:
        """Creates a new `Connect Webview <https://docs.seam.co/core-concepts/connect-webviews>`_.
    ...
    @route_metadata(path="/connect_webviews/delete", has_required_parameters=True, has_pagination=False)
    def delete(self, *, connect_webview_id: str) -> None:
        """Deletes a `Connect Webview <https://docs.seam.co/core-concepts/connect-webviews>`_.
        ...
        if not params:
            raise ValueError("At least one parameter is required for /connect_webviews/delete")

        self.client.delete("/connect_webviews/delete", params=params)

        return None

    @route_metadata(path="/connect_webviews/get", has_required_parameters=True, has_pagination=False)
    def get(self, *, connect_webview_id: str) -> ConnectWebview:
        """Returns a specified `Connect Webview <https://docs.seam.co/core-concepts/connect-webviews>`_.
        ...
        if not params:
            raise ValueError("At least one parameter is required for /connect_webviews/get")

        res = self.client.get("/connect_webviews/get", params=params)

        return ConnectWebview.from_dict(res["connect_webview"])

    @route_metadata(path="/connect_webviews/list", has_required_parameters=False, has_pagination=True)
    def list(self, *, custom_metadata_has: Optional[Dict[str, Any]] = None, customer_key: Optional[str] = None, limit: Optional[float] = None, page_cursor: Optional[Union[str, Null]] = None, search: Optional[str] = None, user_identifier_key: Optional[str] = None) -> List[ConnectWebview]:
        """Returns a list of all `Connect Webviews <https://docs.seam.co/core-concepts/connect-webviews>`_.
