...
@dataclass
class AcsSystemLocation(ResourceMapping):
...
@dataclass
class AcsSystemVisionlineMetadata(ResourceMapping):
...
class AcsSystem:
    ...
    errors: List[AcsSystemErrors]
    external_type: str
    external_type_display_name: str
    image_alt_text: str
    image_url: str
    is_credential_manager: bool
    location: AcsSystemLocation
    name: str
    system_type: str
    system_type_display_name: str
    visionline_metadata: AcsSystemVisionlineMetadata
    warnings: List[AcsSystemWarnings]
    workspace_id: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            errors=[AcsSystemErrors.from_dict(i) for i in d.get("errors") or []],
            ...
            location=(
                AcsSystemLocation.from_dict(d.get("location"))
            ...
            visionline_metadata=(
                AcsSystemVisionlineMetadata.from_dict(d.get("visionline_metadata"))
                if d.get("visionline_metadata") is not None
                else None
            ),
            warnings=[AcsSystemWarnings.from_dict(i) for i in d.get("warnings") or []],
