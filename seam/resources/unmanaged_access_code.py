...
@dataclass
class UnmanagedAccessCodeDormakabaOracodeMetadata(ResourceMapping):
...
@dataclass
class UnmanagedAccessCodeModifiedFields(ResourceMapping):
...
@dataclass
class UnmanagedAccessCodeErrors(ResourceMapping):
    ...
    change_type: str
    modified_fields: List[UnmanagedAccessCodeModifiedFields]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            modified_fields=[
                UnmanagedAccessCodeModifiedFields.from_dict(i)
...
@dataclass
class UnmanagedAccessCodeWarnings(ResourceMapping):
...
class UnmanagedAccessCode:
    ...
    created_at: str
    device_id: str
    dormakaba_oracode_metadata: UnmanagedAccessCodeDormakabaOracodeMetadata
    ends_at: str
    errors: List[UnmanagedAccessCodeErrors]
    is_managed: bool
    name: str
    starts_at: str
    status: str
    type: str
    warnings: List[UnmanagedAccessCodeWarnings]
    workspace_id: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            dormakaba_oracode_metadata=(
                UnmanagedAccessCodeDormakabaOracodeMetadata.from_dict(
            ...
            errors=[
                UnmanagedAccessCodeErrors.from_dict(i) for i in d.get("errors") or []
            ],
            ...
            warnings=[
                UnmanagedAccessCodeWarnings.from_dict(i)
