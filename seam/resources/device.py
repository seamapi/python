...
@dataclass
class DeviceDeviceManufacturer(ResourceMapping):
...
@dataclass
class DeviceDeviceProvider(ResourceMapping):
...
@dataclass
class DeviceLocation(ResourceMapping):
...
@dataclass
class DeviceBattery(ResourceMapping):
...
@dataclass
class DeviceAccessoryKeypad(ResourceMapping):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            battery=(
                DeviceBattery.from_dict(d.get("battery"))
...
@dataclass
class DeviceAppearance(ResourceMapping):
...
@dataclass
class DeviceModel(ResourceMapping):
...
@dataclass
class DeviceEndpoints(ResourceMapping):
...
@dataclass
class DeviceAssaAbloyCredentialServiceMetadata(ResourceMapping):
    ...
    endpoints: List[DeviceEndpoints]
    has_active_endpoint: bool

    @classmethod
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            endpoints=[DeviceEndpoints.from_dict(i) for i in d.get("endpoints") or []],
            has_active_endpoint=d.get("has_active_endpoint", None),
        )


@dataclass
class DeviceSaltoSpaceCredentialServiceMetadata(ResourceMapping):
...
@dataclass
class DeviceAkilesMetadata(ResourceMapping):
...
@dataclass
class DeviceAqaraMetadata(ResourceMapping):
...
@dataclass
class DeviceAssaAbloyVostioMetadata(ResourceMapping):
...
@dataclass
class DeviceAugustMetadata(ResourceMapping):
...
@dataclass
class DeviceAvigilonAltaMetadata(ResourceMapping):
...
@dataclass
class DeviceBrivoMetadata(ResourceMapping):
...
@dataclass
class DeviceControlbywebMetadata(ResourceMapping):
...
@dataclass
class DeviceDeviceId(ResourceMapping):
...
@dataclass
class DevicePredefinedTimeSlots(ResourceMapping):
...
@dataclass
class DeviceDormakabaOracodeMetadata(ResourceMapping):
    ...
    door_name: str
    iana_timezone: str
    predefined_time_slots: List[DevicePredefinedTimeSlots]
    site_id: float
    site_name: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            device_id=(
                DeviceDeviceId.from_dict(d.get("device_id"))
            ...
            predefined_time_slots=[
                DevicePredefinedTimeSlots.from_dict(i)
...
@dataclass
class DeviceEcobeeMetadata(ResourceMapping):
...
@dataclass
class DeviceFourSuitesMetadata(ResourceMapping):
...
@dataclass
class DeviceGenieMetadata(ResourceMapping):
...
@dataclass
class DeviceHoneywellResideoMetadata(ResourceMapping):
...
@dataclass
class DeviceIglooMetadata(ResourceMapping):
...
@dataclass
class DeviceIgloohomeMetadata(ResourceMapping):
...
@dataclass
class DeviceKeynestMetadata(ResourceMapping):
...
@dataclass
class DeviceKisiMetadata(ResourceMapping):
...
@dataclass
class DeviceKorelockMetadata(ResourceMapping):
...
@dataclass
class DeviceKwiksetMetadata(ResourceMapping):
...
@dataclass
class DeviceLocklyMetadata(ResourceMapping):
...
@dataclass
class DeviceAccelerometerZ(ResourceMapping):
...
@dataclass
class DeviceHumidity(ResourceMapping):
...
@dataclass
class DevicePressure(ResourceMapping):
...
@dataclass
class DeviceSound(ResourceMapping):
...
@dataclass
class DeviceTemperature(ResourceMapping):
...
@dataclass
class DeviceLatestSensorValues(ResourceMapping):
    ...
    accelerometer_z: DeviceAccelerometerZ
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            accelerometer_z=(
                DeviceAccelerometerZ.from_dict(d.get("accelerometer_z"))
                if d.get("accelerometer_z") is not None
                else None
            ),
            humidity=(
                DeviceHumidity.from_dict(d.get("humidity"))
                if d.get("humidity") is not None
                else None
            ),
            pressure=(
                DevicePressure.from_dict(d.get("pressure"))
                if d.get("pressure") is not None
                else None
            ),
            sound=(
                DeviceSound.from_dict(d.get("sound"))
                if d.get("sound") is not None
                else None
            ),
            temperature=(
                DeviceTemperature.from_dict(d.get("temperature"))
...
@dataclass
class DeviceMinutMetadata(ResourceMapping):
    ...
    device_id: str
    device_name: str
    latest_sensor_values: DeviceLatestSensorValues
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            latest_sensor_values=(
                DeviceLatestSensorValues.from_dict(d.get("latest_sensor_values"))
...
@dataclass
class DeviceNestMetadata(ResourceMapping):
...
@dataclass
class DeviceNoiseawareMetadata(ResourceMapping):
...
@dataclass
class DeviceNukiMetadata(ResourceMapping):
...
@dataclass
class DeviceOmnitecMetadata(ResourceMapping):
...
@dataclass
class DeviceRingMetadata(ResourceMapping):
...
@dataclass
class DeviceSaltoKsMetadata(ResourceMapping):
...
@dataclass
class DeviceSchlageMetadata(ResourceMapping):
...
@dataclass
class DeviceSeamBridgeMetadata(ResourceMapping):
...
@dataclass
class DeviceSensiMetadata(ResourceMapping):
...
@dataclass
class DeviceSmartthingsMetadata(ResourceMapping):
...
@dataclass
class DeviceTadoMetadata(ResourceMapping):
...
@dataclass
class DeviceTedeeMetadata(ResourceMapping):
...
@dataclass
class DeviceFeatures(ResourceMapping):
...
@dataclass
class DeviceWirelessKeypads(ResourceMapping):
...
@dataclass
class DeviceTtlockMetadata(ResourceMapping):
    ...
    lock_id: float
    timezone_raw_offset_ms: float
    wireless_keypads: List[DeviceWirelessKeypads]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            features=(
                DeviceFeatures.from_dict(d.get("features"))
            ...
            timezone_raw_offset_ms=d.get("timezone_raw_offset_ms", None),
            wireless_keypads=[
                DeviceWirelessKeypads.from_dict(i)
...
@dataclass
class DeviceTwoNMetadata(ResourceMapping):
...
@dataclass
class DeviceUltraloqMetadata(ResourceMapping):
...
@dataclass
class DeviceVisionlineMetadata(ResourceMapping):
...
@dataclass
class DeviceWyzeMetadata(ResourceMapping):
...
@dataclass
class DeviceCodeConstraints(ResourceMapping):
...
@dataclass
class DeviceKeypadBattery(ResourceMapping):
...
@dataclass
class DeviceTimePairs(ResourceMapping):
...
@dataclass
class DeviceOfflineTimeFrameOptions(ResourceMapping):
    ...
    time_pairs: List[DeviceTimePairs]
    time_zone: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            time_pairs=[
                DeviceTimePairs.from_dict(i) for i in d.get("time_pairs") or []
            ],
            time_zone=d.get("time_zone", None),
        )
...
@dataclass
class DeviceOnlineTimeFrameOptions(ResourceMapping):
...
@dataclass
class DeviceActiveThermostatSchedule(ResourceMapping):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            errors=[DeviceErrors.from_dict(i) for i in d.get("errors") or []],
...
@dataclass
class DeviceAvailableClimatePresets(ResourceMapping):
    ...
    display_name: str
    ecobee_metadata: DeviceEcobeeMetadata
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            display_name=d.get("display_name", None),
            ecobee_metadata=(
                DeviceEcobeeMetadata.from_dict(d.get("ecobee_metadata"))
...
@dataclass
class DeviceCurrentClimateSetting(ResourceMapping):
...
@dataclass
class DeviceDefaultClimateSetting(ResourceMapping):
    """
...
@dataclass
class DeviceTemperatureThreshold(ResourceMapping):
...
@dataclass
class DevicePeriods(ResourceMapping):
...
@dataclass
class DeviceThermostatDailyPrograms(ResourceMapping):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            device_id=d.get("device_id", None),
            name=d.get("name", None),
            periods=[DevicePeriods.from_dict(i) for i in d.get("periods") or []],
...
@dataclass
class DeviceThermostatWeeklyProgram(ResourceMapping):
...
@dataclass
class DeviceProperties(ResourceMapping):
    ...
    accessory_keypad: DeviceAccessoryKeypad
    ...
    salto_space_credential_service_metadata: DeviceSaltoSpaceCredentialServiceMetadata
    akiles_metadata: DeviceAkilesMetadata
    aqara_metadata: DeviceAqaraMetadata
    assa_abloy_vostio_metadata: DeviceAssaAbloyVostioMetadata
    august_metadata: DeviceAugustMetadata
    avigilon_alta_metadata: DeviceAvigilonAltaMetadata
    brivo_metadata: DeviceBrivoMetadata
    controlbyweb_metadata: DeviceControlbywebMetadata
    dormakaba_oracode_metadata: DeviceDormakabaOracodeMetadata
    ecobee_metadata: DeviceEcobeeMetadata
    four_suites_metadata: DeviceFourSuitesMetadata
    genie_metadata: DeviceGenieMetadata
    honeywell_resideo_metadata: DeviceHoneywellResideoMetadata
    igloo_metadata: DeviceIglooMetadata
    igloohome_metadata: DeviceIgloohomeMetadata
    keynest_metadata: DeviceKeynestMetadata
    kisi_metadata: DeviceKisiMetadata
    korelock_metadata: DeviceKorelockMetadata
    kwikset_metadata: DeviceKwiksetMetadata
    lockly_metadata: DeviceLocklyMetadata
    minut_metadata: DeviceMinutMetadata
    nest_metadata: DeviceNestMetadata
    noiseaware_metadata: DeviceNoiseawareMetadata
    nuki_metadata: DeviceNukiMetadata
    omnitec_metadata: DeviceOmnitecMetadata
    ring_metadata: DeviceRingMetadata
    salto_ks_metadata: DeviceSaltoKsMetadata
    salto_metadata: DeviceSaltoMetadata
    schlage_metadata: DeviceSchlageMetadata
    seam_bridge_metadata: DeviceSeamBridgeMetadata
    sensi_metadata: DeviceSensiMetadata
    smartthings_metadata: DeviceSmartthingsMetadata
    tado_metadata: DeviceTadoMetadata
    tedee_metadata: DeviceTedeeMetadata
    ttlock_metadata: DeviceTtlockMetadata
    two_n_metadata: DeviceTwoNMetadata
    ultraloq_metadata: DeviceUltraloqMetadata
    visionline_metadata: DeviceVisionlineMetadata
    wyze_metadata: DeviceWyzeMetadata
    auto_lock_delay_seconds: float
    auto_lock_enabled: bool
    backup_access_code_pool_enabled: bool
    code_constraints: List[DeviceCodeConstraints]
    door_open: bool
    has_native_entry_events: bool
    keypad_battery: DeviceKeypadBattery
    locked: bool
    max_active_codes_supported: float
    offline_time_frame_options: List[DeviceOfflineTimeFrameOptions]
    online_time_frame_options: List[DeviceOnlineTimeFrameOptions]
    supported_code_lengths: List[float]
    supports_backup_access_code_pool: bool
    active_thermostat_schedule: DeviceActiveThermostatSchedule
    active_thermostat_schedule_id: str
    available_climate_preset_modes: List[str]
    available_climate_presets: List[DeviceAvailableClimatePresets]
    available_fan_mode_settings: List[str]
    available_hvac_mode_settings: List[str]
    current_climate_setting: DeviceCurrentClimateSetting
    default_climate_setting: DeviceDefaultClimateSetting
    ...
    temperature_threshold: DeviceTemperatureThreshold
    thermostat_daily_program_period_precision_minutes: float
    thermostat_daily_programs: List[DeviceThermostatDailyPrograms]
    thermostat_weekly_program: DeviceThermostatWeeklyProgram

    @classmethod
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            accessory_keypad=(
                DeviceAccessoryKeypad.from_dict(d.get("accessory_keypad"))
                if d.get("accessory_keypad") is not None
                else None
            ),
            appearance=(
                DeviceAppearance.from_dict(d.get("appearance"))
            ...
            manufacturer=d.get("manufacturer", None),
            model=(
                DeviceModel.from_dict(d.get("model"))
            ...
            assa_abloy_credential_service_metadata=(
                DeviceAssaAbloyCredentialServiceMetadata.from_dict(
            ...
            salto_space_credential_service_metadata=(
                DeviceSaltoSpaceCredentialServiceMetadata.from_dict(
            ...
            akiles_metadata=(
                DeviceAkilesMetadata.from_dict(d.get("akiles_metadata"))
                if d.get("akiles_metadata") is not None
                else None
            ),
            aqara_metadata=(
                DeviceAqaraMetadata.from_dict(d.get("aqara_metadata"))
                if d.get("aqara_metadata") is not None
                else None
            ),
            assa_abloy_vostio_metadata=(
                DeviceAssaAbloyVostioMetadata.from_dict(
            ...
            august_metadata=(
                DeviceAugustMetadata.from_dict(d.get("august_metadata"))
                if d.get("august_metadata") is not None
                else None
            ),
            avigilon_alta_metadata=(
                DeviceAvigilonAltaMetadata.from_dict(d.get("avigilon_alta_metadata"))
            ...
            controlbyweb_metadata=(
                DeviceControlbywebMetadata.from_dict(d.get("controlbyweb_metadata"))
                if d.get("controlbyweb_metadata") is not None
                else None
            ),
            dormakaba_oracode_metadata=(
                DeviceDormakabaOracodeMetadata.from_dict(
            ...
            four_suites_metadata=(
                DeviceFourSuitesMetadata.from_dict(d.get("four_suites_metadata"))
                if d.get("four_suites_metadata") is not None
                else None
            ),
            genie_metadata=(
                DeviceGenieMetadata.from_dict(d.get("genie_metadata"))
                if d.get("genie_metadata") is not None
                else None
            ),
            honeywell_resideo_metadata=(
                DeviceHoneywellResideoMetadata.from_dict(
            ...
            igloo_metadata=(
                DeviceIglooMetadata.from_dict(d.get("igloo_metadata"))
                if d.get("igloo_metadata") is not None
                else None
            ),
            igloohome_metadata=(
                DeviceIgloohomeMetadata.from_dict(d.get("igloohome_metadata"))
                if d.get("igloohome_metadata") is not None
                else None
            ),
            keynest_metadata=(
                DeviceKeynestMetadata.from_dict(d.get("keynest_metadata"))
                if d.get("keynest_metadata") is not None
                else None
            ),
            kisi_metadata=(
                DeviceKisiMetadata.from_dict(d.get("kisi_metadata"))
                if d.get("kisi_metadata") is not None
                else None
            ),
            korelock_metadata=(
                DeviceKorelockMetadata.from_dict(d.get("korelock_metadata"))
                if d.get("korelock_metadata") is not None
                else None
            ),
            kwikset_metadata=(
                DeviceKwiksetMetadata.from_dict(d.get("kwikset_metadata"))
            ...
            minut_metadata=(
                DeviceMinutMetadata.from_dict(d.get("minut_metadata"))
                if d.get("minut_metadata") is not None
                else None
            ),
            nest_metadata=(
                DeviceNestMetadata.from_dict(d.get("nest_metadata"))
                if d.get("nest_metadata") is not None
                else None
            ),
            noiseaware_metadata=(
                DeviceNoiseawareMetadata.from_dict(d.get("noiseaware_metadata"))
                if d.get("noiseaware_metadata") is not None
                else None
            ),
            nuki_metadata=(
                DeviceNukiMetadata.from_dict(d.get("nuki_metadata"))
                if d.get("nuki_metadata") is not None
                else None
            ),
            omnitec_metadata=(
                DeviceOmnitecMetadata.from_dict(d.get("omnitec_metadata"))
                if d.get("omnitec_metadata") is not None
                else None
            ),
            ring_metadata=(
                DeviceRingMetadata.from_dict(d.get("ring_metadata"))
                if d.get("ring_metadata") is not None
                else None
            ),
            salto_ks_metadata=(
                DeviceSaltoKsMetadata.from_dict(d.get("salto_ks_metadata"))
                if d.get("salto_ks_metadata") is not None
                else None
            ),
            salto_metadata=(
                DeviceSaltoMetadata.from_dict(d.get("salto_metadata"))
                if d.get("salto_metadata") is not None
                else None
            ),
            schlage_metadata=(
                DeviceSchlageMetadata.from_dict(d.get("schlage_metadata"))
                if d.get("schlage_metadata") is not None
                else None
            ),
            seam_bridge_metadata=(
                DeviceSeamBridgeMetadata.from_dict(d.get("seam_bridge_metadata"))
                if d.get("seam_bridge_metadata") is not None
                else None
            ),
            sensi_metadata=(
                DeviceSensiMetadata.from_dict(d.get("sensi_metadata"))
                if d.get("sensi_metadata") is not None
                else None
            ),
            smartthings_metadata=(
                DeviceSmartthingsMetadata.from_dict(d.get("smartthings_metadata"))
                if d.get("smartthings_metadata") is not None
                else None
            ),
            tado_metadata=(
                DeviceTadoMetadata.from_dict(d.get("tado_metadata"))
                if d.get("tado_metadata") is not None
                else None
            ),
            tedee_metadata=(
                DeviceTedeeMetadata.from_dict(d.get("tedee_metadata"))
                if d.get("tedee_metadata") is not None
                else None
            ),
            ttlock_metadata=(
                DeviceTtlockMetadata.from_dict(d.get("ttlock_metadata"))
                if d.get("ttlock_metadata") is not None
                else None
            ),
            two_n_metadata=(
                DeviceTwoNMetadata.from_dict(d.get("two_n_metadata"))
                if d.get("two_n_metadata") is not None
                else None
            ),
            ultraloq_metadata=(
                DeviceUltraloqMetadata.from_dict(d.get("ultraloq_metadata"))
                if d.get("ultraloq_metadata") is not None
                else None
            ),
            visionline_metadata=(
                DeviceVisionlineMetadata.from_dict(d.get("visionline_metadata"))
                if d.get("visionline_metadata") is not None
                else None
            ),
            wyze_metadata=(
                DeviceWyzeMetadata.from_dict(d.get("wyze_metadata"))
            ...
            code_constraints=[
                DeviceCodeConstraints.from_dict(i)
            ...
            keypad_battery=(
                DeviceKeypadBattery.from_dict(d.get("keypad_battery"))
            ...
            offline_time_frame_options=[
                DeviceOfflineTimeFrameOptions.from_dict(i)
                for i in d.get("offline_time_frame_options") or []
            ],
            online_time_frame_options=[
                DeviceOnlineTimeFrameOptions.from_dict(i)
            ...
            active_thermostat_schedule=(
                DeviceActiveThermostatSchedule.from_dict(
            ...
            available_climate_presets=[
                DeviceAvailableClimatePresets.from_dict(i)
            ...
            current_climate_setting=(
                DeviceCurrentClimateSetting.from_dict(d.get("current_climate_setting"))
                if d.get("current_climate_setting") is not None
                else None
            ),
            default_climate_setting=(
                DeviceDefaultClimateSetting.from_dict(d.get("default_climate_setting"))
            ...
            temperature_threshold=(
                DeviceTemperatureThreshold.from_dict(d.get("temperature_threshold"))
            ...
            thermostat_daily_programs=[
                DeviceThermostatDailyPrograms.from_dict(i)
                for i in d.get("thermostat_daily_programs") or []
            ],
            thermostat_weekly_program=(
                DeviceThermostatWeeklyProgram.from_dict(
...
class Device:
    ...
    device_id: str
    device_manufacturer: DeviceDeviceManufacturer
    device_provider: DeviceDeviceProvider
    device_type: str
    display_name: str
    errors: List[DeviceErrors]
    is_managed: bool
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            device_id=d.get("device_id", None),
            device_manufacturer=(
                DeviceDeviceManufacturer.from_dict(d.get("device_manufacturer"))
                if d.get("device_manufacturer") is not None
                else None
            ),
            device_provider=(
                DeviceDeviceProvider.from_dict(d.get("device_provider"))
            ...
            location=(
                DeviceLocation.from_dict(d.get("location"))
                if d.get("location") is not None
                else None
            ),
            nickname=d.get("nickname", None),
            properties=(
                DeviceProperties.from_dict(d.get("properties"))
                if d.get("properties") is not None
                else None
            ),
            space_ids=d.get("space_ids", None),
            warnings=[DeviceWarnings.from_dict(i) for i in d.get("warnings") or []],
            workspace_id=d.get("workspace_id", None),
        )
