...
@dataclass
class AccessGrantErrors(ResourceMapping):
...
@dataclass
class AccessGrantFrom(ResourceMapping):
...
@dataclass
class AccessGrantTo(ResourceMapping):
...
@dataclass
class AccessGrantPendingMutations(ResourceMapping):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            created_at=d.get("created_at", None),
            from_=(
                AccessGrantFrom.from_dict(d.get("from"))
            ...
            to=(
                AccessGrantTo.from_dict(d.get("to"))
...
@dataclass
class AccessGrantRequestedAccessMethods(ResourceMapping):
...
@dataclass
class AccessGrantFailedDevices(ResourceMapping):
...
@dataclass
class AccessGrantWarnings(ResourceMapping):
    ...
    message: str
    warning_code: str
    failed_devices: List[AccessGrantFailedDevices]
    access_method_ids: List[str]
    device_id: str
    new_code: str
    original_code: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            failed_devices=[
                AccessGrantFailedDevices.from_dict(i)
...
class AccessGrant:
    ...
    display_name: str
    ends_at: str
    errors: List[AccessGrantErrors]
    instant_key_url: str
    location_ids: List[str]
    name: str
    pending_mutations: List[AccessGrantPendingMutations]
    requested_access_methods: List[AccessGrantRequestedAccessMethods]
    reservation_key: str
    space_ids: List[str]
    starts_at: str
    user_identity_id: str
    warnings: List[AccessGrantWarnings]
    workspace_id: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            errors=[AccessGrantErrors.from_dict(i) for i in d.get("errors") or []],
            instant_key_url=d.get("instant_key_url", None),
            location_ids=d.get("location_ids", None),
            name=d.get("name", None),
            pending_mutations=[
                AccessGrantPendingMutations.from_dict(i)
                for i in d.get("pending_mutations") or []
            ],
            requested_access_methods=[
                AccessGrantRequestedAccessMethods.from_dict(i)
            ...
            warnings=[
                AccessGrantWarnings.from_dict(i) for i in d.get("warnings") or []
            ],
