...
@dataclass
class ThermostatDailyProgramPeriods(ResourceMapping):
...
class ThermostatDailyProgram:
    ...
    device_id: str
    name: str
    periods: List[ThermostatDailyProgramPeriods]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            periods=[
                ThermostatDailyProgramPeriods.from_dict(i)
                for i in d.get("periods") or []
            ],
