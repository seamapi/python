...
@dataclass
class AccessCodeDormakabaOracodeMetadata(ResourceMapping):
...
@dataclass
class AccessCodeModifiedFields(ResourceMapping):
...
class AccessCodeErrors(ResourceMapping):
    ...
    change_type: str
    modified_fields: List[AccessCodeModifiedFields]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            modified_fields=[
                AccessCodeModifiedFields.from_dict(i)
...
@dataclass
class AccessCodeFrom(ResourceMapping):
...
@dataclass
class AccessCodeTo(ResourceMapping):
...
@dataclass
class AccessCodePendingMutations(ResourceMapping):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            from_=(
                AccessCodeFrom.from_dict(d.get("from"))
                if d.get("from") is not None
                else None
            ),
            to=AccessCodeTo.from_dict(d.get("to")) if d.get("to") is not None else None,
        )
...
class AccessCode:
    ...
    created_at: str
    device_id: str
    dormakaba_oracode_metadata: AccessCodeDormakabaOracodeMetadata
    ends_at: str
    errors: List[AccessCodeErrors]
    is_backup: bool
    ...
    name: str
    pending_mutations: List[AccessCodePendingMutations]
    pulled_backup_access_code_id: str
    starts_at: str
    status: str
    type: str
    warnings: List[AccessCodeWarnings]
    workspace_id: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            dormakaba_oracode_metadata=(
                AccessCodeDormakabaOracodeMetadata.from_dict(
            ...
            errors=[AccessCodeErrors.from_dict(i) for i in d.get("errors") or []],
            ...
            pending_mutations=[
                AccessCodePendingMutations.from_dict(i)
            ...
            warnings=[AccessCodeWarnings.from_dict(i) for i in d.get("warnings") or []],
