...
@dataclass
class AcsEntranceActions(ResourceMapping):
...
@dataclass
class AcsEntranceAkilesMetadata(ResourceMapping):
    ...
    actions: List[AcsEntranceActions]
    gadget_id: str
    site_id: str
    site_name: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            actions=[AcsEntranceActions.from_dict(i) for i in d.get("actions") or []],
...
@dataclass
class AcsEntranceAssaAbloyVostioMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceAvigilonAltaMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceBrivoMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceDormakabaAmbianceMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceDormakabaCommunityMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceErrors(ResourceMapping):
...
@dataclass
class AcsEntranceHotekMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceLatchMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceSaltoKsMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceSaltoSpaceMetadata(ResourceMapping):
...
@dataclass
class AcsEntranceProfiles(ResourceMapping):
...
@dataclass
class AcsEntranceVisionlineMetadata(ResourceMapping):
    ...
    door_category: str
    door_name: str
    profiles: List[AcsEntranceProfiles]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            door_name=d.get("door_name", None),
            profiles=[
                AcsEntranceProfiles.from_dict(i) for i in d.get("profiles") or []
            ],
        )


@dataclass
class AcsEntranceWarnings(ResourceMapping):
...
class AcsEntrance:
    ...
    acs_entrance_id: str
    acs_system_id: str
    akiles_metadata: AcsEntranceAkilesMetadata
    assa_abloy_vostio_metadata: AcsEntranceAssaAbloyVostioMetadata
    avigilon_alta_metadata: AcsEntranceAvigilonAltaMetadata
    brivo_metadata: AcsEntranceBrivoMetadata
    ...
    created_at: str
    display_name: str
    dormakaba_ambiance_metadata: AcsEntranceDormakabaAmbianceMetadata
    dormakaba_community_metadata: AcsEntranceDormakabaCommunityMetadata
    errors: List[AcsEntranceErrors]
    hotek_metadata: AcsEntranceHotekMetadata
    is_locked: bool
    latch_metadata: AcsEntranceLatchMetadata
    salto_ks_metadata: AcsEntranceSaltoKsMetadata
    salto_space_metadata: AcsEntranceSaltoSpaceMetadata
    space_ids: List[str]
    visionline_metadata: AcsEntranceVisionlineMetadata
    warnings: List[AcsEntranceWarnings]
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            akiles_metadata=(
                AcsEntranceAkilesMetadata.from_dict(d.get("akiles_metadata"))
                if d.get("akiles_metadata") is not None
                else None
            ),
            assa_abloy_vostio_metadata=(
                AcsEntranceAssaAbloyVostioMetadata.from_dict(
            ...
            avigilon_alta_metadata=(
                AcsEntranceAvigilonAltaMetadata.from_dict(
                    d.get("avigilon_alta_metadata")
                )
            ...
            dormakaba_ambiance_metadata=(
                AcsEntranceDormakabaAmbianceMetadata.from_dict(
            ...
            dormakaba_community_metadata=(
                AcsEntranceDormakabaCommunityMetadata.from_dict(
                    d.get("dormakaba_community_metadata")
                )
                if d.get("dormakaba_community_metadata") is not None
                else None
            ),
            errors=[AcsEntranceErrors.from_dict(i) for i in d.get("errors") or []],
            hotek_metadata=(
                AcsEntranceHotekMetadata.from_dict(d.get("hotek_metadata"))
                if d.get("hotek_metadata") is not None
                else None
            ),
            is_locked=d.get("is_locked", None),
            latch_metadata=(
                AcsEntranceLatchMetadata.from_dict(d.get("latch_metadata"))
                if d.get("latch_metadata") is not None
                else None
            ),
            salto_ks_metadata=(
                AcsEntranceSaltoKsMetadata.from_dict(d.get("salto_ks_metadata"))
                if d.get("salto_ks_metadata") is not None
                else None
            ),
            salto_space_metadata=(
                AcsEntranceSaltoSpaceMetadata.from_dict(d.get("salto_space_metadata"))
                if d.get("salto_space_metadata") is not None
                else None
            ),
            space_ids=d.get("space_ids", None),
            visionline_metadata=(
                AcsEntranceVisionlineMetadata.from_dict(d.get("visionline_metadata"))
                if d.get("visionline_metadata") is not None
                else None
            ),
            warnings=[
                AcsEntranceWarnings.from_dict(i) for i in d.get("warnings") or []
            ],
        )
