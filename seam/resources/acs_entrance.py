...
class AcsEntrance:
    ...
    :ivar acs_entrance_id: ID of the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype acs_entrance_id: str

    :ivar acs_system_id: ID of the [access control system](https://docs.seam.co/low-level-apis/access-systems) that contains the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype acs_system_id: str

    :ivar akiles_metadata: Akiles-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype akiles_metadata: Dict[str, Any]

    :ivar assa_abloy_vostio_metadata: ASSA ABLOY Vostio-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype assa_abloy_vostio_metadata: Dict[str, Any]

    :ivar avigilon_alta_metadata: Avigilon Alta-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype avigilon_alta_metadata: Dict[str, Any]

    :ivar brivo_metadata: Brivo-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    ...
    :ivar connected_account_id: ID of the [connected account](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details) associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype connected_account_id: str

    :ivar created_at: Date and time at which the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details) was created.
    :vartype created_at: str

    :ivar display_name: Display name for the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype display_name: str

    :ivar dormakaba_ambiance_metadata: dormakaba Ambiance-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype dormakaba_ambiance_metadata: Dict[str, Any]

    :ivar dormakaba_community_metadata: dormakaba Community-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype dormakaba_community_metadata: Dict[str, Any]

    :ivar errors: Errors associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype errors: List[Dict[str, Any]]

    :ivar hotek_metadata: Hotek-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype hotek_metadata: Dict[str, Any]

    :ivar is_locked: Indicates whether the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details) is currently locked.
    :vartype is_locked: bool

    :ivar latch_metadata: Latch-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype latch_metadata: Dict[str, Any]

    :ivar salto_ks_metadata: Salto KS-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype salto_ks_metadata: Dict[str, Any]

    :ivar salto_space_metadata: Salto Space-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    ...
    :ivar visionline_metadata: Visionline-specific metadata associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
    :vartype visionline_metadata: Dict[str, Any]

    :ivar warnings: Warnings associated with the [entrance](https://docs.seam.co/low-level-apis/access-systems/retrieving-entrance-details).
