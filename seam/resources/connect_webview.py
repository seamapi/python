...
class ConnectWebview:
    ...
    :ivar accepted_providers: List of accepted [provider keys](https://docs.seam.co/core-concepts/connect-webviews/customizing-connect-webviews#customize-the-brands-to-display-in-your-connect-webviews).
    :vartype accepted_providers: List[str]

    :ivar any_provider_allowed: Indicates whether any provider is allowed.
    :vartype any_provider_allowed: bool
    ...
    :vartype authorized_at: str

    :ivar automatically_manage_new_devices: Indicates whether Seam should [import all new devices](https://docs.seam.co/core-concepts/connect-webviews/customizing-connect-webviews#automatically_manage_new_devices) for the connected account to make these devices available for use and management by the Seam API.
    ...
    :vartype custom_redirect_failure_url: str
    ...
    :vartype custom_redirect_url: str
    ...
    :vartype device_selection_mode: str

    :ivar login_successful: Indicates whether the user logged in successfully using the Connect Webview.
    :vartype login_successful: bool

    :ivar selected_provider: Selected provider of the Connect Webview, one of the [provider keys](https://docs.seam.co/core-concepts/connect-webviews/customizing-connect-webviews#customize-the-brands-to-display-in-your-connect-webviews).
    :vartype selected_provider: str
    ...
    :ivar wait_for_device_creation: Indicates whether Seam should [finish syncing all devices](https://docs.seam.co/core-concepts/connect-webviews/customizing-connect-webviews#wait_for_device_creation) in a newly-connected account before completing the associated Connect Webview.
    :vartype wait_for_device_creation: bool
