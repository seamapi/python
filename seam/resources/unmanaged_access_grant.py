...
@dataclass
class UnmanagedAccessGrantErrors(ResourceMapping):
...
@dataclass
class UnmanagedAccessGrantFrom(ResourceMapping):
...
@dataclass
class UnmanagedAccessGrantTo(ResourceMapping):
...
@dataclass
class UnmanagedAccessGrantPendingMutations(ResourceMapping):
    ...
    created_at: str
    from_: UnmanagedAccessGrantFrom
    message: str
    mutation_code: str
    to: UnmanagedAccessGrantTo
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            created_at=d.get("created_at", None),
            from_=(
                UnmanagedAccessGrantFrom.from_dict(d.get("from"))
            ...
            to=(
                UnmanagedAccessGrantTo.from_dict(d.get("to"))
...
@dataclass
class UnmanagedAccessGrantRequestedAccessMethods(ResourceMapping):
...
@dataclass
class UnmanagedAccessGrantFailedDevices(ResourceMapping):
...
@dataclass
class UnmanagedAccessGrantWarnings(ResourceMapping):
    ...
    message: str
    warning_code: str
    failed_devices: List[UnmanagedAccessGrantFailedDevices]
    access_method_ids: List[str]
    device_id: str
    new_code: str
    original_code: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            failed_devices=[
                UnmanagedAccessGrantFailedDevices.from_dict(i)
...
class UnmanagedAccessGrant:
    ...
    display_name: str
    ends_at: str
    errors: List[UnmanagedAccessGrantErrors]
    location_ids: List[str]
    name: str
    pending_mutations: List[UnmanagedAccessGrantPendingMutations]
    requested_access_methods: List[UnmanagedAccessGrantRequestedAccessMethods]
    reservation_key: str
    space_ids: List[str]
    starts_at: str
    user_identity_id: str
    warnings: List[UnmanagedAccessGrantWarnings]
    workspace_id: str
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            errors=[
                UnmanagedAccessGrantErrors.from_dict(i) for i in d.get("errors") or []
            ],
            location_ids=d.get("location_ids", None),
            name=d.get("name", None),
            pending_mutations=[
                UnmanagedAccessGrantPendingMutations.from_dict(i)
                for i in d.get("pending_mutations") or []
            ],
            requested_access_methods=[
                UnmanagedAccessGrantRequestedAccessMethods.from_dict(i)
            ...
            warnings=[
                UnmanagedAccessGrantWarnings.from_dict(i)
