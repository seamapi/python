...
from .routes import AbstractAsyncRoutes, AbstractRoutes
...
class AbstractAsyncSeam(AbstractAsyncRoutes):
    @abc.abstractmethod
    def __init__(
        self,
        api_key: Optional[str] = None,
...
class AbstractAsyncSeamWithoutWorkspaceWorkspaces(abc.ABC):
    @abc.abstractmethod
    async def create(
        self,
        *,
